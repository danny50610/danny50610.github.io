    ...
    <table>
        <thead>
            <tr class="text-center">
                ...
                <th scope="col" style="width: 24%; white-space: nowrap">(54C)境內股利所得</th>
                <th scope="col" style="width: 23%; white-space: nowrap">(76W)財產交易所得</th>
                <th scope="col" style="width: 23%; white-space: nowrap">資本公積</th>
            </tr>
        </thead>
        {% assign typeList = "54C股利,76W財產交易,資本公積" | split: "," %}
